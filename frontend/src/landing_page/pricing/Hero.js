  ...
  return (
    <div className='container'>
        ...
        <div className='row mt-5 text-center'>
            <div className='col-4'>
              <img src='media/images/pricing0.svg' style={{width:"70%"}} className='mb-3' alt='pricing'/>
            ...
            <div className='col-4'>
              <img src='media/images/intradayTrades.svg' style={{width:"70%"}} className='mb-3' alt='intraday'/>
            ...
            <div className='col-4'>
                <img src='media/images/pricingEquity.svg' style={{width:"70%"}} className='mb-3' alt='equity'/>
